...
export function themeVars(theme: Theme): CSSProperties {
  ...
  return {
    ...
    '--c-bg-overlay': ui.bgOverlay,
    '--c-bg-input': ui.bgInput,
    '--c-bg-hover': ui.bgHover,
    '--c-bg-active': ui.bgActive,
    '--c-border': ui.border,
    '--c-border-strong': ui.borderStrong,
    '--c-text': ui.text,
    '--c-text-muted': ui.textMuted,
    '--c-text-subtle': ui.textSubtle,
    '--c-accent': ui.accent,
    '--c-accent-rgb': rgbTriplet(ui.accent),
    '--c-accent-text': ui.accentText,
    '--c-success': ui.success,
    '--c-warning': ui.warning,
    '--c-danger': ui.danger,
    '--c-selection': ui.selection,
    '--c-line-highlight': ui.lineHighlight,
    '--c-cursor': ui.cursor,
    '--c-gutter': ui.gutter,
    '--s-type': syntaxColor(theme, 'type'),
    '--s-function': syntaxColor(theme, 'function'),
