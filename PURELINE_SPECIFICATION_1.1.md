<!--toc:start-->
- [Pureline Specification 1.1](#pureline-specification-11)
  - [Definition](#definition)
- [1. Pureline Core](#1-pureline-core)
- [2. Control Flow](#2-control-flow)
  - [PL-CF-001 — Prefer Guard Clauses](#pl-cf-001-prefer-guard-clauses)
  - [PL-CF-002 — Avoid `else`](#pl-cf-002-avoid-else)
  - [PL-CF-003 — Explicit Blocks in Brace-Based Languages](#pl-cf-003-explicit-blocks-in-brace-based-languages)
- [3. Naming](#3-naming)
  - [PL-NAME-001 — Names Must Be Meaningful](#pl-name-001-names-must-be-meaningful)
- [4. Functions](#4-functions)
  - [PL-FN-001 — One Clear Responsibility](#pl-fn-001-one-clear-responsibility)
    - [Size guidance](#size-guidance)
- [5. Classes and Modules](#5-classes-and-modules)
  - [PL-STRUCT-001 — One Clear Responsibility](#pl-struct-001-one-clear-responsibility)
- [6. Formatting](#6-formatting)
  - [PL-FMT-001 — Prefer Compact Horizontal Calls](#pl-fmt-001-prefer-compact-horizontal-calls)
- [7. Comments](#7-comments)
  - [PL-DOC-001 — Comments Explain Why, Not What](#pl-doc-001-comments-explain-why-not-what)
- [8. Java Profile](#8-java-profile)
  - [PL-JAVA-001 — Package by Responsibility](#pl-java-001-package-by-responsibility)
  - [PL-JAVA-002 — Naming](#pl-java-002-naming)
  - [PL-JAVA-003 — Prefer Records for Immutable Data](#pl-java-003-prefer-records-for-immutable-data)
  - [PL-JAVA-004 — Explicit Null Handling](#pl-java-004-explicit-null-handling)
  - [PL-JAVA-005 — Use Imports Instead of FQCNs](#pl-java-005-use-imports-instead-of-fqcns)
  - [PL-JAVA-006 — Prefer Modern Java](#pl-java-006-prefer-modern-java)
  - [PL-JAVA-007 — Prefer Switch for Real State Branching](#pl-java-007-prefer-switch-for-real-state-branching)
  - [PL-JAVA-008 — Concurrency](#pl-java-008-concurrency)
  - [PL-JAVA-009 — Streams Only When Clearer](#pl-java-009-streams-only-when-clearer)
  - [PL-JAVA-010 — Lifecycle Symmetry](#pl-java-010-lifecycle-symmetry)
- [9. JavaScript Profile](#9-javascript-profile)
  - [PL-JS-001 — Braces Are Mandatory](#pl-js-001-braces-are-mandatory)
  - [PL-JS-002 — Use Semicolons](#pl-js-002-use-semicolons)
  - [PL-JS-003 — `const` First](#pl-js-003-const-first)
  - [PL-JS-004 — Prefer `async` / `await`](#pl-js-004-prefer-async-await)
  - [PL-JS-005 — Arrow Functions Are Contextual](#pl-js-005-arrow-functions-are-contextual)
  - [PL-JS-006 — Destructuring Must Improve Clarity](#pl-js-006-destructuring-must-improve-clarity)
- [10. TypeScript Profile](#10-typescript-profile)
  - [PL-TS-001 — Avoid `any`](#pl-ts-001-avoid-any)
  - [PL-TS-002 — Use Types Deliberately](#pl-ts-002-use-types-deliberately)
  - [PL-TS-003 — No Java-Style `I` Prefix](#pl-ts-003-no-java-style-i-prefix)
  - [PL-TS-004 — `interface` vs `type`](#pl-ts-004-interface-vs-type)
  - [PL-TS-005 — Prefer Union Types Over Enums When Appropriate](#pl-ts-005-prefer-union-types-over-enums-when-appropriate)
  - [PL-TS-006 — Strong Types at Boundaries, Freedom Internally](#pl-ts-006-strong-types-at-boundaries-freedom-internally)
- [11. Go Profile](#11-go-profile)
  - [PL-GO-001 — Error Guards](#pl-go-001-error-guards)
  - [PL-GO-002 — Avoid `else` After Terminating Branches](#pl-go-002-avoid-else-after-terminating-branches)
  - [PL-GO-003 — Naming Must Remain Idiomatic](#pl-go-003-naming-must-remain-idiomatic)
  - [PL-GO-004 — Short Receiver Names Are Allowed](#pl-go-004-short-receiver-names-are-allowed)
  - [PL-GO-005 — Small Interfaces](#pl-go-005-small-interfaces)
  - [PL-GO-006 — Define Interfaces Near Consumers](#pl-go-006-define-interfaces-near-consumers)
  - [PL-GO-007 — Use `defer` for Clear Resource Lifecycles](#pl-go-007-use-defer-for-clear-resource-lifecycles)
  - [PL-GO-008 — Goroutines Need Ownership](#pl-go-008-goroutines-need-ownership)
  - [PL-GO-009 — Avoid Premature Interface Abstraction](#pl-go-009-avoid-premature-interface-abstraction)
- [12. Crystal Profile](#12-crystal-profile)
  - [PL-CR-001 — Idiomatic Postfix Guards Are Allowed](#pl-cr-001-idiomatic-postfix-guards-are-allowed)
  - [PL-CR-002 — Avoid `else`](#pl-cr-002-avoid-else)
  - [PL-CR-003 — Idiomatic Naming](#pl-cr-003-idiomatic-naming)
  - [PL-CR-004 — Prefer Type Inference](#pl-cr-004-prefer-type-inference)
  - [PL-CR-005 — Explicit Nil Guards](#pl-cr-005-explicit-nil-guards)
  - [PL-CR-006 — Exceptions Are for Exceptional States](#pl-cr-006-exceptions-are-for-exceptional-states)
  - [PL-CR-007 — Avoid Macro Cleverness Without Need](#pl-cr-007-avoid-macro-cleverness-without-need)
- [13. Abstraction Rules](#13-abstraction-rules)
  - [PL-ARCH-001 — Abstraction Requires a Reason](#pl-arch-001-abstraction-requires-a-reason)
- [14. Architecture](#14-architecture)
- [15. Side Effects](#15-side-effects)
- [16. Immutability](#16-immutability)
- [17. Dependencies](#17-dependencies)
- [18. Performance](#18-performance)
- [19. Language Profiles](#19-language-profiles)
- [20. Tooling Model](#20-tooling-model)
- [21. Pureline Summary](#21-pureline-summary)
<!--toc:end-->
