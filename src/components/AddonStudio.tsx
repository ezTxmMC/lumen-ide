...
import {
  AlertTriangle, Blocks, Braces, Check, Code2, Download, FolderTree, Hammer, Palette, Scissors, Settings2, Trash2, Workflow, X, Zap,
} from 'lucide-react'
...
import { LanguagesPage } from './addon-studio/LanguagesPage'
import { CommandsPage, EventsPage } from './addon-studio/GraphPages'
import { TemplatesPage } from './addon-studio/TemplatesPage'
import { KindsPage } from './addon-studio/KindsPage'
import { SnippetsPage } from './addon-studio/SnippetsPage'
import { GeneralPage, JsonPage, ThemesPage } from './addon-studio/MetaPages'
