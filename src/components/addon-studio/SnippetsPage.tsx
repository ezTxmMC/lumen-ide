...
export function SnippetsPage({
  ...
  const languages = useMemo(() => {
    ...
    for (const language of model.languages) out.set(language.id, language.name || language.id)
    for (const language of registry.languages()) out.set(language.id, language.name)
    return [...out.entries()]
  }, [model.languages])
