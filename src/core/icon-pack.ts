...
export const ICON_SHAPE_NAMES = [
  'file', 'file-code', 'file-text', 'file-json', 'file-cog', 'file-lock', 'file-type',
  'folder', 'folder-open', 'folder-git', 'folder-cog', 'folder-code', 'folder-kanban',
  'braces', 'code', 'terminal', 'hash', 'type', 'binary', 'component',
  'lock', 'key', 'shield-check', 'fingerprint',
  'package', 'boxes', 'box', 'blocks', 'archive', 'container', 'ship', 'anchor',
  'settings', 'cog', 'wrench', 'hammer', 'pickaxe', 'workflow', 'webhook', 'layers',
  'git-branch', 'git-merge', 'github',
  'book-open', 'book-marked', 'scale', 'receipt', 'languages',
  'database', 'table', 'sheet', 'server', 'cloud', 'globe',
  'image', 'palette', 'music', 'video',
  'flask', 'test-tube', 'bug', 'eye',
  'coffee', 'leaf', 'gem', 'feather', 'atom', 'zap', 'flame', 'rocket', 'sparkles',
  'cpu', 'smartphone', 'gamepad', 'puzzle', 'link', 'list-tree',
  'diamond', 'hexagon', 'triangle', 'circle', 'square', 'star', 'heart',
] as const
